...
describe("CustomersController", () => {
  ...
  describe("create", () => {
    it("requires customers:create permission", () => {
      const metadata = Reflect.getMetadata("permissions", CustomersController.prototype.create);
  ...
  describe("findById", () => {
    it("requires customers:read permission", () => {
      const metadata = Reflect.getMetadata("permissions", CustomersController.prototype.findById);
      expect(metadata).toContain("customers:read");
    });
  ...
  describe("update", () => {
    it("requires customers:edit permission", () => {
      const metadata = Reflect.getMetadata("permissions", CustomersController.prototype.update);
  ...
  describe("softDelete", () => {
    it("requires customers:delete permission", () => {
      const metadata = Reflect.getMetadata("permissions", CustomersController.prototype.softDelete);
