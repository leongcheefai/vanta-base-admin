...
export class CustomersService {
  ...
  async list(query: ListCustomersDto) {
    ...
    const orderCol = query.sort === "name" ? schema.customer.name : schema.customer.createdAt;
  ...
  async update(id: string, dto: UpdateCustomerDto, actorId: string, ctx?: AuditContext) {
