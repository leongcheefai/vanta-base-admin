...
export class AuthGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    const request = context
      .switchToHttp()
      .getRequest<Request & { user: SessionUser | null; session: SessionSession | null }>();
    ...
    if (userWithDeleted.deletedAt || userWithDeleted.banned) throw new UnauthorizedException();
